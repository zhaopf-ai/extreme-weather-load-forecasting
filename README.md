...
**["Deep Multi-Modal Fusion and Kalman Online Adaptation for Electric Load Forecasting Against Extreme Rainfall Events"](https://ieeexplore.ieee.org/document/11500566)**  
...
Install the dataset in the directory `data/`. The datasets used in this work are derived from real-world data sources in Australia, including:
